...
int runtime_tool_shop(GameRuntime *runtime, char *message, size_t message_size);
int runtime_buy_tool(GameRuntime *runtime, int tool, char *message, size_t message_size);
int runtime_select_shop_item(GameRuntime *runtime, int tool, char *message, size_t message_size);
int runtime_select_gift(GameRuntime *runtime, int gift, char *message, size_t message_size);
int runtime_resolve_landing(GameRuntime *runtime, int accept, char *message, size_t message_size);
...
int runtime_sell_property(GameRuntime *runtime, int position,
                          char *message, size_t message_size);
