@echo off
rem ============================================================
rem  RichMan A3_A17_A21 - MSVC build script (Windows)
rem  Usage:  double-click or run  build.bat  in cmd
rem  Output: bin\A3_A17_A21.exe   (objects in obj\)
rem ============================================================
...
cl /nologo /W4 /utf-8 /std:c11 /Iinclude /Fo:obj\ /Fe:bin\A3_A17_A21.exe src\*.c
if errorlevel 1 (
    echo [ERROR] Build failed.
    exit /b 1
)

echo [OK] Build succeeded: bin\A3_A17_A21.exe
endlocal
