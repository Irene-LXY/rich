@echo off
rem ============================================================
rem  RichMan - MSVC build script (Windows)
rem  Usage:  double-click or run  build.bat  in cmd
rem  Output: bin\richman.exe   (objects in obj\)
rem ============================================================
...
cl /nologo /W4 /utf-8 /std:c11 /Iinclude /Fo:obj\ /Fe:bin\richman.exe src\*.c
if errorlevel 1 (
    echo [ERROR] Build failed.
    exit /b 1
)

echo [OK] Build succeeded: bin\richman.exe
endlocal
